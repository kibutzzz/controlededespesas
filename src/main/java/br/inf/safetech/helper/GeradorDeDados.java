...
public class GeradorDeDados {
	...
	public static List<Usuario> gerarUsuarios() {
		...
		usuarios.add(criaUsuario("usuario.inativo", "usuario demitido", "123", SituacaoUsuario.INATIVO,
				TipoUsuario.COLABORADOR));
		usuarios.add(criaUsuario("admin.inativo", "admin demitido", "4456", SituacaoUsuario.INATIVO,
				TipoUsuario.ADMIN));

		return usuarios;
	}

	private static Usuario criaUsuario(String login, String nome, String senha, SituacaoUsuario situacao,
			TipoUsuario tipo) {
